package org.example.cafe.start;
import org.example.cafe.connection.HibernateConfig;
import org.example.cafe.service.BillingService;
import org.example.cafe.service.MenuItemCRUD;
import org.example.cafe.service.OrderItemCRUD;
...
public class Main {
    public static void main(String[] args) {
        ...
        try (AnnotationConfigApplicationContext context =
            ...
            MenuItemCRUD menuItemCRUD = context.getBean(MenuItemCRUD.class);
            OrderItemCRUD orderItemCRUD = context.getBean(OrderItemCRUD.class);
